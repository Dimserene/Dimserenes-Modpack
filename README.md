...
- [Lovely](https://github.com/ethangreen-dev/lovely-injector) 0.5.0-beta6 (latest release)
...
- [Steamodded](https://github.com/Steamopollys/Steamodded?tab=readme-ov-file) 1.0.0-Alpha-0625a (latest main code)
...
- [Bunco](https://github.com/Firch/Bunco/tree/main) 5.0 June 26 build (latest main code)
