...
- [__Blank Joker__](https://github.com/GitNether/nethers-jokers) 1.0.0 (latest release) By Nether
...
- [__Betmma Series__](https://github.com/betmma/my_balatro_mods) 2.1.5 (latest release) By Betmma
...
- [__Bunco__](https://github.com/Firch/Bunco/tree/main) 5.0 June 26 build (latest main code) By Firch
...
- [__Codex Arcanum__](https://github.com/itayfeder/Codex-Arcanum) 1.1.4 (latest release) By itayfeder
...
- [__D6 Jokers__](https://github.com/GauntletGames-2086/D6-Jokers) 0.5.21 (latest main code) By ItsFlowwey
...
- [__Deck Creator__](https://github.com/adambennett/Balatro-DeckCreator) 1.2.1 (latest release) By Nyoxide
...
- [__DX Tarots__](https://github.com/JeffVi/DX-Tarots) Eighth release (latest release) By JeffVi
...
- [__House Rules__](https://github.com/Mysthaps/BalatroMods) 1.4.2 (latest release) By Myst
...
- [__Jank Jonklers__](https://spikeof2010.github.io/JankJonklers/) 0.21.2 (latest release) By Lyman
...
- [__Jimbo's Pack__](https://github.com/art-muncher/Jimbo-s-Pack) First update (latest release) By elial1
...
- [__Lobotomy Corporation__](https://github.com/Mysthaps/LobotomyCorp) 0.5.4 (latest release) By Myst
...
- [__Loop__](https://discord.com/channels/1116389027176787968/1248431147784863840) 1.0.0 (latest release) By jenwalter666
...
- [__Math Blinds__](https://github.com/Bazinga9000/MathBlinds) June 25 build (latest main code) By Bazinga_900
...
- [__Myst's Boss Blinds__](https://github.com/Mysthaps/MystBlinds) 1.2.5b (latest release) By Myst
